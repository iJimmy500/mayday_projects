...
export const CATEGORIES = {
  ...
  energy: {
    ...
    baseUnit: 'J',
    units: [
      { id: 'match',               label: 'burning matches',                  value: 1_000,                   difficulty: 1, hint: 'Energy released by a single match head' },
      { id: 'aa_battery',          label: 'AA batteries',                     value: 15_840,                  difficulty: 1, hint: 'Typical alkaline AA (4.4 Wh)' },
      { id: 'food_calorie',        label: 'food calories (kcal)',             value: 4_184,                   difficulty: 1, hint: '1 dietary Calorie = 4,184 joules' },
      ...
      { id: 'lightning_bolt',      label: 'lightning bolts',                  value: 1_000_000_000,           difficulty: 1, hint: 'Approximate energy in a single lightning strike (~1 GJ)' },
